...
def main():
    ...
    while True:
        clock.tick(SPEED)
        pygame.display.update()  # Отрисовываем изменения.
        handle_keys(snake)
